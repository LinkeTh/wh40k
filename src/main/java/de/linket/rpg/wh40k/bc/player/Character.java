...
@JsonPropertyOrder({ "id", "name", "state", "clazz", "race", "wounds", "psyRating", "initiative", "pride", "disgrace", "motivation", "characteristics", "skills", "talents" })
public class Character {
	...
	public void removeModifier(Modifier<?> modifier) {
		...
		switch (modifier.getModifierType()) {
		case CHARACTERISTIC: {
			List<Characteristic> result = this.getCharacteristics().stream().filter(i -> i.getType().equals(modifier.getType())).collect(Collectors.toList());
