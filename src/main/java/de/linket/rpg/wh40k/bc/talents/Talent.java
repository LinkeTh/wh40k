package de.linket.rpg.wh40k.bc.talents;
...
public class Talent implements GameObject, Advanceable
{
	...
	public void advance(Experience cost)
	{
		if(this.getType().isAdvancable())
		{
			...
			//this.modifiers.addAll(this.modifiers.stream().flatMap(m -> Stream.generate(() -> m).limit(this.getAdvances())).collect(Collectors.toList()));
		}
	}
