...
public class ForsakenTraitWrapper implements SelectionWrapper<TraitType>
{
    @Override
    public List<SelectionContainer<TraitType>> getSelectionContainer()
    {
        ...
        SelectionContainer<TraitType> c1 = new SingleComposer<TraitType>(TraitType.RESOURCEFUL);
        result.add(c1);
