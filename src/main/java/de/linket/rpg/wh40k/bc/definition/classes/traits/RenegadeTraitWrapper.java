...
public class RenegadeTraitWrapper implements SelectionWrapper<TraitType>
{
    @Override
    public List<SelectionContainer<TraitType>> getSelectionContainer()
    {
        ...
        SelectionContainer<TraitType> c1 = new SingleComposer<TraitType>(TraitType.RENEGADE_CLASS);
        SelectionContainer<TraitType> c2 = new SingleComposer<TraitType>(TraitType.ADROIT);
