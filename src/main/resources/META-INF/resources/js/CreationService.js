...
function CreationService($rootScope, $http)
{
    ...
    this.getSkillsForCreation = function($race, $class)
    {
        var url = 'http://localhost:9000/api/v1/creation/character/' + $class.name + "/" + $race.name + "/skills";
    ...
    this.getTalentsForCreation = function($race, $class)
    {
        var url = 'http://localhost:9000/api/v1/creation/character/' + $class.name + "/" + $race.name + "/talents";
